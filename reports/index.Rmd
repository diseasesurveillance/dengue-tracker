...
### Estimated number of cases in each state using Google Trends (using data until `r format(as.Date(max(model_preds$ew_start)), "%d-%m-%y")`)
...
model_preds <- generate_data_all_country(gamma = 0.90)
