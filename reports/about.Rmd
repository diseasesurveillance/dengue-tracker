...
For InfoDengue estimates and weekly reports on municipality level, visit their [platform](https://info.dengue.mat.br/){target="_blank"}. The InfoDengue estimates used on our graphs are made by summing the estimates for all cities in a given state.