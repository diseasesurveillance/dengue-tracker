...
The red curve is the predicted region. The model is trained using all data until five weeks before the last date. Green curve shows the reported number of cases, subject to delays, and blue curve is the fitted model.
![São Paulo](figures/sp_qr.png)
